...
// Page pour afficher tous les paiements (accessible uniquement aux admins)
export default function AllPaiementsPage() {
  ...
  useEffect(() => {
    const fetchPaiements = async () => {
      try {
        ...
        const res = await fetch("/api/paiements/dashboard", {
          method: "GET",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paiements.map((p) => (
              <div
                ...
                className={`bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer hover:bg-gradient-to-br hover:from-purple-200 hover:to-purple-400 ${
              ...
              >
                ...
                <div className="space-y-2 text-gray-600">
                  ...
                  <p>
                    <span className="font-medium">ParkingSpot ID:</span>{" "}
                    {p.parkingSpotId}
                  </p>
                  <p>
