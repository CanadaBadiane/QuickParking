          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mt-8 flex flex-col gap-4">
              <div className="flex gap-4">
                {!isEditing ? (
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors font-medium cursor-pointer"
                  >
                    Modifier
                  </button>
                ) : (
                  <>
                    <button
                      ...
                      className="flex-1 bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition-colors font-medium cursor-pointer"
                    >
                      Enregistrer
                    </button>
                    <button
                      ...
                      className="flex-1 bg-gray-600 text-white py-3 px-6 rounded-lg hover:bg-gray-700 transition-colors font-medium cursor-pointer"
                    >
                      Annuler
                    </button>
                  </>
              ...
              <button
                ...
                className="w-full bg-red-600 text-white py-3 px-6 rounded-lg hover:bg-red-700 transition-colors font-medium cursor-pointer"
              >
                Supprimer le compte
              </button>
            </div>
